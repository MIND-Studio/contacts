...
/**
 * Renders its children only when Contacts runs **standalone**. Inside the Mind
 * shell (brokered mode) it renders nothing — the shell already provides the
 * chrome (app title, navigation, app launcher, theme), so Contacts' own
 * masthead would be redundant duplicate chrome inside the shell's app body.
 *
 ...
 * overlay (it clears on `mind:ready`, which Contacts fires only after this
 * resolves).
 */
